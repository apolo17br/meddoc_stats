...
import styles from './ForgetPasswordScreenConfirmation.module.css'

export function ForgetPasswordScreenConfirmation() {
          ...
          <div className={`${styles.mainContent}`}>
            ...
            >
              <Container centerContent>
                ...
                <Text className={`${styles.registerSubtitle}`}> Encaminhamos as instruções de recuperação de senha via e-mail. </Text>
              </Container>
              ...
              <div className={`${styles.buttonBox}`}>
                <Button
                  ...
                  color='white'
                  variant='solid'
                  onClick={() => navigate("/criar-nova-senha")}
                >
                  ACESSAR EMAIL
                </Button>
              </div>
