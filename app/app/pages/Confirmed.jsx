...
import { ActionModalEditar } from '../components/actionModalEditar';
  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: '#38b6ff', height: '100%' }}>
      ...
      <View style={styles.subHeader}>
        <Text style={styles.title}>CONFIRMAÇÕES</Text>
      </View>
      ...
      <View style={styles.background}>
        ...
        <View style={styles.card}>
          ...
          <Text style={{ color: '#000', fontFamily: 'Inter', fontSize: ' 18px' }}>Tipo do atendimento</Text>
          ...
          <View style={{ flexDirection: 'row', width: '100%', justifyContent: 'space-between' }}>
            <TouchableOpacity style={styles.buttons} onPress={ () => setVisibleModal(true)}>
              <Text style={styles.buttonText}>Editar</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.buttons}>
              <Text style={styles.buttonText}>Sala de espera</Text>
            </TouchableOpacity>
          </View>
        </View>
